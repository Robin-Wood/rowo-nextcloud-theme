...
class OC_Theme {
	...
	public function getTitle() {
		return 'ROBIN WOOD Aktivenplattform';
	}
	...
	public function getShortFooter() {
		$footer = '<a href="'.$this->getBaseUrl().'" target="_blank\">'.$this->getEntity().'</a> 2017'.
			'<br/>' . $this->getSlogan();
